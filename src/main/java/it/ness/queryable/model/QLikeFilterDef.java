...
public class QLikeFilterDef extends FilterDefBase {
    ...
    public QLikeFilterDef(final Log log, final StringUtil stringUtil) {
    ...
    @Override
    public QLikeFilterDef parseQFilterDef(FieldSource<JavaClassSource> f) {
        ...
        QLikeFilterDef fd = new QLikeFilterDef(log, stringUtil);
        fd.prefix = prefix;
        fd.name = name;
